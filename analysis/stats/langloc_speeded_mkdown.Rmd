...
data <- subset(data, (Condition != "S-N" & Hemisphere == "LH" & ROI != "LAngG"))
...
```{r Fig 1 (d)}
data <- read.csv("../data/mROI_lang_S-N.csv", header=TRUE)
data <- subset(data, (Condition =="S" & Hemisphere == "LH" & ROI != "LAngG"))
data$Version <- factor(data$Version, levels = c("Standard", "Speeded"))
lme <- EffectSize ~ 1 + Version + (1|UID) + (1|ROI)
model <- lmer(lme, data=data, REML=FALSE)
summary = summary(model)
...
```{r Fig 1 (e)}
data <- read.csv("../data/mROI_lang_S-N.csv", header=TRUE)
data <- subset(data, (Condition =="N" & Hemisphere == "LH" & ROI != "LAngG"))
data$Version <- factor(data$Version, levels = c("Standard", "Speeded"))
lme <- EffectSize ~ 1 + Version + (1|UID) + (1|ROI)
model <- lmer(lme, data=data, REML=FALSE)
summary = summary(model)
...
data <- subset(data, (Condition =="H" & Hemisphere == "LH" & ROI != "LAngG"))
data$Version <- factor(data$Version, levels = c("Standard", "Speeded"))
lme <- EffectSize ~ 1 + Version + (1|UID) + (1|ROI)
model <- lmer(lme, data=data, REML=FALSE)
summary = summary(model)
...
```{r Fig 2 (C-D pt3)}
data <- read.csv("../data/mROI_lang_H-E.csv", header=TRUE)
data <- subset(data, (Condition =="E" & Hemisphere == "LH" & ROI != "LAngG"))
data$Version <- factor(data$Version, levels = c("Standard", "Speeded"))
lme <- EffectSize ~ 1 + Version + (1|UID) + (1|ROI)
model <- lmer(lme, data=data, REML=FALSE)
summary = summary(model)
...
```{r SI 1B (a)}
data <- read.csv("../data/mROI_lang_S-N.csv", header=TRUE)
data <- subset(data, (Condition != "S-N" & Hemisphere == "RH" & ROI != "RAngG"))
data$Version <- factor(data$Version, levels = c("Standard", "Speeded"))
lme <- EffectSize ~ 1 + Condition + Version + (1|UID) + (1|ROI)
model_1 <- lmer(lme, data=data, REML=FALSE)
summary = summary(model_1)
...
data <- read.csv("../data/mROI_lang_S-N.csv", header=TRUE)
data <- subset(data, (Condition == "S" & Hemisphere == "RH" & ROI != "RAngG"))
data$Version <- factor(data$Version, levels = c("Standard", "Speeded"))
lme <- EffectSize ~ 1 + Version + (1|UID) + (1|ROI)
model <- lmer(lme, data=data, REML=FALSE)
summary = summary(model)
...
```{r SI 1B (e)}
data <- read.csv("../data/mROI_lang_S-N.csv", header=TRUE)
data <- subset(data, (Condition == "N" & Hemisphere == "RH" & ROI != "RAngG"))
data$Version <- factor(data$Version, levels = c("Standard", "Speeded"))
lme <- EffectSize ~ 1 + Version + (1|UID) + (1|ROI)
model <- lmer(lme, data=data, REML=FALSE)
summary = summary(model)
...
data <- subset(data, (Hemisphere == "LH" & ROI != "LAngG" & grepl("SpCorr", Version) & Condition == "within"))
...
```{r spcorr averaged}
data <- read.csv("../data/spatial_corr_lang.csv", header=TRUE)
data <- subset(data, (Hemisphere == "LH" & ROI != "LAngG" & grepl("SpCorr", Version)))
...
```{r dice70_averaged}
data <- read.csv("../data/spatial_corr_lang.csv", header=TRUE)
data <- subset(data, (Hemisphere == "LH" & ROI != "LAngG" & grepl("Dice", Version) & grepl("70", Version)))
lme <- Coefficient ~ 1 + Condition + (1|UID) + (1|ROI)
model_1 <- lmer(lme, data=data, REML=FALSE)
summary = summary(model_1)
print(summary, digits=10)
...
```{r dice80_averaged}
data <- read.csv("../data/spatial_corr_lang.csv", header=TRUE)
data <- subset(data, (Hemisphere == "LH" & ROI != "LAngG" & grepl("Dice", Version) & grepl("80", Version)))
lme <- Coefficient ~ 1 + Condition + (1|UID) + (1|ROI)
model_1 <- lmer(lme, data=data, REML=FALSE)
summary = summary(model_1)
print(summary, digits=10)
...
```{r dice90_averaged}
data <- read.csv("../data/spatial_corr_lang.csv", header=TRUE)
data <- subset(data, (Hemisphere == "LH" & ROI != "LAngG" & grepl("Dice", Version) & grepl("90", Version)))
lme <- Coefficient ~ 1 + Condition + (1|UID) + (1|ROI)
model_1 <- lmer(lme, data=data, REML=FALSE)
summary = summary(model_1)
print(summary, digits=10)
